...
function processImage() {  
    ...
    var apiKey = "a0504a80e585f2c8ca9d35865b66087a";
    var uploadImgUrl = "https://api.imgbb.com/1/upload?key=" + apiKey;

    var formData = new FormData();
    formData.append('image', base64Img);
    
    var uploadedImgUrl = null;    
    $('#loadingText').css('display', 'inline-block');    
    $('#loading').css('display', 'inline-block'); 
    $('#loadingDiv').css('display', 'inline-flex');        
    $('#loadingText').text("Subiendo imágen...");
    $('#predictionResult').text("");
    ...
    $.ajax({
        ...
        success: function(result){
            ...
            var uploadedImgUrl = result.data.url;

            $('#loadingText').text("Procesando...");

            var predictionUrl = "https://cat-dog-img-clsf.glitch.me/predict";
            var body = {};
            body.image = uploadedImgUrl;            
